---
title: "As an Admin push "Create Permissions" button"
---

# As an Admin push "Create Permissions" button
...
This file is a duplicate of `Admin_push__Create_Permissions__button.md`. The endpoint `PUT /dataflow/validateAllReporters` is confirmed correct. See `Admin_push__Create_Permissions__button.md` for the full verification note.
