...
This file is a duplicate of `Access_containers_with_kubectl.md`. No source code verification applicable — operational runbook. The namespace, cluster URL, and project ID should be verified against the current environment. See `Access_containers_with_kubectl.md` for the full verification note.
